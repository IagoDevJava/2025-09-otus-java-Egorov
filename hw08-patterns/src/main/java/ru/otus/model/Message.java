...
public class Message {
    ...
    public Message(
        ...
        if (field13 == null) {
            ...
            List<String> originalData = field13.getData();
            if (originalData != null) {
                copy.setData(List.copyOf(originalData));
            }
            this.field13 = copy;
        }
    }
    ...
    public ObjectForMessage getField13() {
        ...
        ObjectForMessage exposedCopy = new ObjectForMessage();
        exposedCopy.setData(field13.getData());
        return exposedCopy;
    }
